...
const AGENT_LABELS: Record<string, string> = {
    red_team: "🔴 Red Team", exposure: "🔍 Exposure", headers_tls: "🔒 Headers & TLS",
...
export default function ReportPage() {
    ...
    useEffect(() => {
        if (!runId) return;
        setLoading(true);
        fetch(`http://127.0.0.1:5000/runs/${runId}/report`)
            .then((r) => r.json())
            .then((data) => {
                    ...
                    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.8 }}
                        ...
                        <div className="text-sm text-gray-400 space-y-3 leading-relaxed print:text-gray-600">
                            ...
                            <ul className="list-disc list-inside space-y-1 ml-2">
                                <li><strong className="text-gray-300 print:text-gray-700">Red Team Agent</strong> — Browser-automated pentesting with LLM-guided decision making (GPT-4o-mini)</li>
                                <li><strong className="text-gray-300 print:text-gray-700">Exposure Scanner</strong> — Secret detection in client-side JavaScript bundles and DOM</li>
                                <li><strong className="text-gray-300 print:text-gray-700">Headers &amp; TLS</strong> — Security header analysis and TLS configuration review</li>
                                <li><strong className="text-gray-300 print:text-gray-700">SQL Injection</strong> — Automated SQLi payload fuzzing on form inputs</li>
                                ...
                                <li><strong className="text-gray-300 print:text-gray-700">LLM Analysis</strong> — AI-powered code and configuration analysis</li>
                            </ul>
                    ...
                    <motion.footer initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 1 }}
                        ...
                        <div className="flex items-center justify-center gap-6 mt-5 text-xs font-mono text-gray-600">
                            <span className="flex items-center gap-1.5">
                                <Bot className="w-3.5 h-3.5" /> Attack Intelligence: OpenAI GPT
                            </span>
                            <span className="text-gray-800">•</span>
                            <span className="flex items-center gap-1.5">
                                <Sparkles className="w-3.5 h-3.5 text-blue-400" /> Defense Intelligence: Google Gemini
                            </span>
                        </div>
                    </motion.footer>
                </div>
